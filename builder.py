...
class BareboneBuilder:
    ...
    def build_kernel(self):
        ...
        self.execute_command("gcc -c -o /tmp/base.o ./file/base.c",True)
        fff=f'nasm -f elf  "$1" -o /tmp/kernel.o'.replace("$1",filename)
        
        self.execute_command(fff,True)
        
        self.execute_command("ld -nostdlib -T  ./file/link.ld /tmp/boot.o  /tmp/base.o /tmp/kernel.o  -o /tmp/hello.elf",True)
